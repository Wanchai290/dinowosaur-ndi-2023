	  ...
	  <div className="flex justify-center items-center h-full w-full overflow-scroll">
		  ...
		  <div
			  ...
			  style={{backgroundImage: "url(rpg_game_assets/background/beach.png)", backgroundSize: "contain", backgroundRepeat: "no-repeat", position:"relative", height: "1024px", width:"1024px", overflow:"hidden"}}>
				  ...
				  <NPCComponent isPlayer={false} baseY={10} baseX={-15} sprite="rpg_game_assets/citadin1.png" dialogSetter={()=>{}} dialogId={null} dialogIdSetter={null} map={null} />
				  <NPCComponent isPlayer={false} baseY={-12} baseX={5} sprite="rpg_game_assets/paysan3.png" dialogSetter={()=>{}}  dialogId={null} dialogIdSetter={null} map={null}/>
				  {currentDialog}
		  </div>
	  </div>
  )
